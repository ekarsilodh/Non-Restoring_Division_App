...
st.set_page_config(
    page_title="Non-Restoring Division Calculator",
    page_icon="🧮",
    layout="centered",
...
st.markdown(
    """
    <h1 style='text-align: center; font-family: Pacifico, sans-serif'>Non-Restoring Division Calculator</h1>
    """,
    unsafe_allow_html=True
)
...
print("\nNon-Restoring Division Algorithm Calculator\n")
    ...
    if no1 and no2:
        ...
        while(size!=0):
            ...
            if (A[0] == '0'):
                ...
                calc_data = ['Sign of A is +ve; ALS(AQ)', str(M), str(A), str(Q), '-']
                #print(calc_data)
                data.append(calc_data)

                A = sb(A, M)

                calc_data = ['A=A-M', str(M), str(A), str(Q), '-']
                #print(calc_data)
                data.append(calc_data)
                ...
                if (A[0] == '0'):
                    ...
                    calc_data = ['As sign of A -ve; Q[0]=0', str(M), str(A), str(Q), size]
                    #print(calc_data)
                    data.append(calc_data)
        ...
        while(size == 0):
            if (A[0] == '1'):
                ...
                calc_data = ['Restore A', str(M), str(A), str(Q), '-']
                data.append(calc_data)
